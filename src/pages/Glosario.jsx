        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="relative max-w-xl mx-auto group">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 bg-white dark:bg-slate-800/90 backdrop-blur-md rounded-xl shadow-2xl text-slate-900 dark:text-white font-medium border-2 border-transparent focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all placeholder:text-slate-500"
              value={busqueda}
                  ...
                  <div key={index} className="bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-300 dark:border-slate-700 shadow-md overflow-hidden hover:border-emerald-500/50 hover:scale-[1.01] transition-all">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`h-8 w-1.5 rounded-full bg-${item.sectorColor}-500 shadow-[0_0_10px_rgba(0,0,0,0.2)]`}></div>
                      ...
                      <div className={`p-2 rounded-full transition-all ${isOpen ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white' : 'text-slate-400 dark:text-slate-600 group-hover:text-emerald-500'}`}>
                    ...
                    {isOpen && (
                      <div className="px-6 pb-6 pt-2 border-t-2 border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 animate-in slide-in-from-top-2 duration-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          {/* Importancia Card */}
                          <div className="bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-xl border-2 border-blue-100 dark:border-blue-800/30">
                             <span className="block text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-wide mb-2">
                           ...
                           <li key={index} className="rounded-xl overflow-hidden transition-all duration-300">
                             ...
                             {isOpen && (
                               <div className="px-4 pb-5 pt-2 bg-white dark:bg-slate-900 animate-in slide-in-from-top-2 duration-200">
                                 ...
                                 {/* Importancia */}
                                 <div>
                                   <span className="inline-block px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-[10px] font-bold text-blue-700 dark:text-blue-400 uppercase tracking-wide mb-2">
                                     Importancia
                                   </span>
                                   <p className="text-sm text-blue-800/80 dark:text-blue-300 font-medium leading-relaxed">{item.importancia}</p>
                                 </div>
                               </div>
                             )}
                           </li>
        ...
        <div className="mt-16 bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-10 border-2 border-slate-300 dark:border-slate-700 shadow-md relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide border-l-4 border-emerald-500 pl-3">
                Fuente de Datos
              </h4>
            ...
            {/* 2. Periodicidad */}
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide border-l-4 border-blue-500 pl-3">
                Periodicidad
              </h4>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed pl-4">
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide border-l-4 border-purple-500 pl-3">
            ...
            {/* 4. Estacionalidad */}
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 dark:text-slate-100 text-sm uppercase tracking-wide border-l-4 border-orange-500 pl-3">
                Estacionalidad
              </h4>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed pl-4">
