      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md">
            ...
            {/* Capital */}
            <div className="mb-4">
              <label className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">Capital a Invertir</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none transition-all dark:text-white font-medium"
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                <label className="text-sm font-medium text-slate-600 dark:text-slate-400">Días de Inmovilización</label>
              ...
              <input
                ...
                className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer dark:bg-slate-700 accent-violet-600"
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1">TNA Billeteras (%)</label>
                <div className="relative">
                  <input
                    type="number" value={tnaBilletera} onChange={(e) => setTnaBilletera(e.target.value)}
                    className="w-full p-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg text-sm dark:text-white focus:border-violet-500 transition-colors"
                  />
                  <div className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-600 dark:text-slate-400 text-xs">%</div>
                </div>
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1">TNA Plazo Fijo (%)</label>
                <div className="relative">
                  <input
        ...
        <div className="lg:col-span-7">
          {resultado ? (
            <div className="flex flex-col h-full gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className={`relative p-5 rounded-2xl border-2 transition-all ${resultado.ganador === 'billetera' ? 'border-emerald-500 bg-emerald-50/50 dark:bg-emerald-900/10' : 'border-transparent bg-white dark:bg-slate-900 opacity-75'}`}>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-slate-700 dark:text-slate-200 text-sm">Billetera Virtual</h3>
                  </div>
                  <p className="text-2xl font-black text-slate-900 dark:text-white">
                    ${new Intl.NumberFormat('es-AR').format(Math.floor(resultado.billetera))}
                  </p>
                  <p className="text-xs text-slate-500 mt-1">Rendimiento neto</p>
                </div>
                ...
                <div className={`relative p-5 rounded-2xl border-2 transition-all ${resultado.ganador === 'pf' ? 'border-emerald-500 bg-emerald-50/50 dark:bg-emerald-900/10' : 'border-transparent bg-white dark:bg-slate-900 opacity-75'}`}>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-bold text-slate-700 dark:text-slate-200 text-sm">Plazo Fijo</h3>
                  </div>
                  <p className="text-2xl font-black text-slate-900 dark:text-white">
              ...
              <div className="flex-1 bg-slate-100 dark:bg-slate-800 p-6 rounded-2xl border border-slate-300 dark:border-slate-700 flex flex-col justify-center">
                ...
                {resultado.ganador === 'pf' ? (
                  ...
                  <>
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-900 dark:text-white text-lg">Costo de la Liquidez</h4>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-300 dark:border-slate-700 flex items-center justify-between">
                      <span className="text-sm font-medium text-slate-500">Pérdida neta estimada</span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 dark:text-white">¡Conviene la Liquidez!</h4>
            ...
            // Estado Vacío
            <div className="h-full flex flex-col items-center justify-center text-slate-400 dark:text-slate-600 border-2 border-dashed border-slate-300 dark:border-slate-800 rounded-2xl bg-slate-50/50 dark:bg-slate-900/50">
